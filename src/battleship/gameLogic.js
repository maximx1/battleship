var gameLogic = {
  determinePlayersBoardView: function(playersBoard, opponentAttempts) {
  ...
  determineHitView: function(opponentsBoard, playersAttempts) {
  ...
  validateArrays: function(array1, array2) {
